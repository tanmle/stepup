      ...
      <div className="card p-xl">
        ...
        {step === 4 && (
          <div className="animate-fade-in text-center">
            ...
            <div className="text-left space-y-sm max-w-md mx-auto">
              {[
                ...
                <div key={item.label} className="flex justify-between items-center p-sm bg-surface-container-low rounded-xl">
                  <span className="text-label-sm text-on-surface-variant">{item.label}</span>
                  <span className="text-body-md font-medium text-on-surface">{item.value}</span>
                </div>
              ))}
            </div>
          </div>
        ...
        <div className="flex items-center justify-between mt-xl pt-lg border-t border-outline-variant/20">
          ...
          <button
            onClick={step === 4 ? () => alert('Đăng ký thành công!') : nextStep}
